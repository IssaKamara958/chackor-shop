  ...
  return (
    <html lang="fr" suppressHydrationWarning>
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&family=Roboto+Slab:wght@700;800&display=swap" rel="stylesheet" />
        <script
            ...
            dangerouslySetInnerHTML={{ __html: JSON.stringify({
              ...
              "sameAs": [
                "https://www.facebook.com/profile.php?id=100074472115745"
              ]
            }) }}
          />
      </head>
